...
# env.mvform.BMM.1 <- mvBM(tree = env.Simmap, data = form.md76,
...
# env.mvform.BMM.2 <- mvBM(tree = env.Simmap, data = form.md76,
#                          error = me.form.md76, model = "BMM",
...
# env.mvform.BMM.3 <- mvBM(tree = env.Simmap, data = form.md76,
#                          error = me.form.md76, model = "BMM",
...
# env.mvform.BMM.4 <- mvBM(tree = env.Simmap, data = form.md76,
#                          error = me.form.md76, model = "BMM",
...
env.mvform.BMM.5 <- mvBM(tree = env.Simmap, data = form.md76,
                         error = me.form.md76, model = "BMM",
...
env.mvform.BMM.1$AICc
env.mvform.BMM.2$AICc
env.mvform.BMM.3$AICc
env.mvform.BMM.4$AICc
env.mvform.BMM.5$AICc
